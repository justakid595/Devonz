...
export const StyleGroup = memo(({ label, icon, defaultOpen = false, children }: StyleGroupProps) => {
  ...
  return (
    <div className="border-b border-devonz-elements-borderColor last:border-b-0">
      <button
        onClick={toggle}
        className="w-full flex items-center gap-2 px-3 py-2.5 text-xs font-medium text-devonz-elements-textSecondary hover:text-devonz-elements-textPrimary hover:bg-devonz-elements-background-depth-3 transition-colors"
